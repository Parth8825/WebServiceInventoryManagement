<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="WebServiceInventoryManagement.Order" %>
    ...
    <asp:UpdatePanel ID="panel1" runat="server">
        <ContentTemplate>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList class="form-control" ID="dlCustomerId" runat="server" AppendDataBoundItems="true">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group row">
